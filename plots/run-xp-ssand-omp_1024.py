...
# Recommended Plot:
# plots/easyplot.py -if ssand-omp_1024.csv -v omp_tiled  -- col=schedule row=label
...
easypapOptions = {
    ...
    "-wt": ["opt"],
    "-s": [1024],
    "-ts": [8, 16, 32, 64, 128, 512, 1024],
    "--label": ["omp_tiled"],
    "-of": ["ssand-omp_1024.csv"],
}
...
easypapOptions["-th"] = [1]
easypapOptions["-tw"] = [8, 16, 32, 64, 128, 512, 1024]
...
print(" plots/easyplot.py -if ssand-omp_1024.csv -v omp_tiled -- col=schedule row=label")
