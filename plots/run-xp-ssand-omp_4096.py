...
# Recommended Plot:
# plots/easyplot.py -if ssand-omp_4096.csv -v omp_tiled  -- col=schedule row=label
...
easypapOptions = {
    ...
    "-wt": ["opt"],
    "-s": [4096],
    "-ts": [64, 128, 512, 1024, 2048, 4096],
    "--label": ["omp_tiled"],
    "-of": ["ssand-omp_4096.csv"],
}
...
easypapOptions["-th"] = [1]
easypapOptions["-tw"] = [512, 1024, 2048, 4096]
...
print(" plots/easyplot.py -if ssand-omp_4096.csv -v omp_tiled -- col=schedule row=label")
