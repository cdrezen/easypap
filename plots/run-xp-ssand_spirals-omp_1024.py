...
# Recommended Plot:
# plots/easyplot.py -if ssand_spirals-omp_1024.csv -v omp_tiled  -- col=schedule row=label
...
easypapOptions["-th"] = [1, 4, 8, 16, 32, 64]
easypapOptions["-tw"] = [128, 512, 1024]
...
print(" plots/easyplot.py -if ssand_spirals-omp_1024.csv -v omp_tiled -- col=schedule row=label")
